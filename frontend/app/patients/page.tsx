...
const mockPatients: Patient[] = [
  { id: 1, name: "นาย สมชาย ใจดี", age: 72, room: "A-101", condition: "ความดันโลหิตสูง", deviceId: "AA:BB:CC:DD:EE:01", avatar: "สช" },
  { id: 2, name: "นาง สมศรี มีสุข", age: 68, room: "A-102", condition: "เบาหวาน", deviceId: "AA:BB:CC:DD:EE:02", avatar: "สศ" },
  { id: 3, name: "นาย ประเสริฐ ดีงาม", age: 81, room: "B-201", condition: "โรคหัวใจ", deviceId: "AA:BB:CC:DD:EE:03", avatar: "ปส" },
  { id: 4, name: "นาง วิไล รักษ์สุข", age: 75, room: "B-202", condition: "ข้อเสื่อม", deviceId: "AA:BB:CC:DD:EE:04", avatar: "วล" },
  { id: 5, name: "นาย มานะ สู้ชีวิต", age: 65, room: "C-301", condition: "ปอดอักเสบ", deviceId: "AA:BB:CC:DD:EE:05", avatar: "มน" },
];
...
export default function PatientsPage() {
  ...
  const [form, setForm] = useState({ name: "", age: "", room: "", condition: "", deviceId: "" });
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
            ...
            <div className="space-y-4">
              {[
                { label: "ชื่อ-นามสกุล", key: "name", placeholder: "นาย/นาง/นางสาว ชื่อ นามสกุล", type: "text" },
                { label: "อายุ", key: "age", placeholder: "เช่น 72", type: "number" },
                { label: "หมายเลขห้อง/เตียง", key: "room", placeholder: "เช่น A-101", type: "text" },
                { label: "โรคประจำตัว", key: "condition", placeholder: "เช่น ความดันโลหิตสูง", type: "text" },
