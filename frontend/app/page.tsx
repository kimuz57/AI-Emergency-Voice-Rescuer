    ...
    <div className="relative min-h-screen overflow-hidden font-sans transition-colors duration-300">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-b border-white/50 dark:border-slate-700/50 px-4 md:px-12 py-3 flex justify-between items-center shadow-sm transition-colors duration-300">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          <a
            href="/login"
            className="px-2 sm:px-3 py-2 neu-text-muted hover:text-blue-600 dark:hover:text-blue-400 font-bold transition-all text-xs sm:text-base"
          >
            Sign In
          </a>
          <a
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-24 md:pt-32 pb-20">
        {/* <div className="neu-card inline-flex items-center gap-2 px-3 md:px-4 py-2 rounded-full border-purple-100 mb-6 md:mb-8">
          <span className="flex h-2 w-2 md:h-2.5 md:w-2.5 relative">
            ...
            <span className="text-[10px] md:text-xs font-bold neu-text-muted uppercase tracking-wider">
            AI Voice Detection Active
          </span>
        </div> */}

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-4 md:mb-6 neu-text tracking-tight leading-tight">
        ...
        <p className="text-base md:text-xl neu-text-muted mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-4">
      ...
      <section className="relative z-10 py-12 md:py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <div className="neu-card p-6 md:p-8 hover:-translate-y-1 transition-all group">
            ...
            <h3 className="font-bold text-base md:text-lg mb-2 neu-text">
              BCResNet Engine
            </h3>

            <p className="text-sm neu-text-muted leading-relaxed">
