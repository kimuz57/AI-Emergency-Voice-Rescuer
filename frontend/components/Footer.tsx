...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 w-full z-40 py-6 border-t border-gray-200 dark:border-slate-700 bg-white/90 dark:bg-slate-900/90 backdrop-blur-lg transition-colors duration-300">
