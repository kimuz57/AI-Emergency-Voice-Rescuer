...
char mqtt_broker_uri_dynamic[128] = "wss://192.168.1.108:8083/mqtt";
...
#if IS_LOCAL_ENV
    // --- ตั้งค่าสำหรับ Local ---
    #define TARGET_GO_API "https://192.168.1.108:8080/api/checkin?ip=%s"
    #define TARGET_MQTT_URI "wss://192.168.1.108:8083"
...
static void kwsapi_task(void *pvParameters) {
    ...
    esp_http_client_config_t config = {
        ...
        .timeout_ms = 5000, 
        // 🌟 แก้ไข: ใช้ใบรับรองของเรา และย้าย skip_cert เข้ามาไว้ข้างใน
...
static const char *server_cert = 
    "-----BEGIN CERTIFICATE-----\n"
    "MIIFCjCCA3KgAwIBAgIQdzufqid2/v4vxtAEWwvIrjANBgkqhkiG9w0BAQsFADCB\n"
    "/zEeMBwGA1UEChMVbWtjZXJ0IGRldmVsb3BtZW50IENBMWowaAYDVQQLDGFERVNL\n"
    "VE9QLThSU0RDUUpcSlJjb21AREVTS1RPUC04UlNEQ1FKICjguYHguJ/guJnguJzg\n"
    "uKHguYDguJvguYfguJnguKHguLLguKrguYTguKPguYDguJTguK3guKPguYwpMXEw\n"
    "bwYDVQQDDGhta2NlcnQgREVTS1RPUC04UlNEQ1FKXEpSY29tQERFU0tUT1AtOFJT\n"
    "RENRSiAo4LmB4Lif4LiZ4Lic4Lih4LmA4Lib4LmH4LiZ4Lih4Liy4Liq4LmE4Lij\n"
    "4LmA4LiU4Lit4Lij4LmMKTAeFw0yNjA3MDExNTM4MzlaFw0yODEwMDExNTM4Mzla\n"
    "MIGVMScwJQYDVQQKEx5ta2NlcnQgZGV2ZWxvcG1lbnQgY2VydGlmaWNhdGUxajBo\n"
    "BgNVBAsMYURFU0tUT1AtOFJTRENRSlxKUmNvbUBERVNLVE9QLThSU0RDUUogKOC5\n"
    "geC4n+C4meC4nOC4oeC5gOC4m+C5h+C4meC4oeC4suC4quC5hOC4o+C5gOC4lOC4\n"
    "reC4o+C5jCkwggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQC5TlPLUIID\n"
    "bD56xpOJwcgQNqpo97Gpa6jnusWynC1n3YY1Y45xld9TuDkbetMe56ehbYF+8bEU\n"
    "PBKs0YPMLwJ43zB2bj2p06NuIPMWRBuWib/HnPdvCXUyYd2nYWayPsPnpCNaD1Pf\n"
    "rP2GQyOV653u5jEwqW93GRrFiiOdc3Ae30QDPl711jfxBrvk12lMpif15+KX5t1w\n"
    "cpz4qYpEfunPwB0BR3dHWP6BUpkpymMy9B6lJ+SNLGkofsN8ASvG7B6XR/G2Eur9\n"
    "DpXsNEjbsPlc6DBkTQSPH/jorG4pQoNF0ry44SSBFbVRbHgSxtcMi3wya1RXatBH\n"
    "crLn5ShLqAGtAgMBAAGjajBoMA4GA1UdDwEB/wQEAwIFoDATBgNVHSUEDDAKBggr\n"
    "BgEFBQcDATAfBgNVHSMEGDAWgBTAxQY7Lxl406Xq9I57Omc48GvlMjAgBgNVHREE\n"
    "GTAXgglsb2NhbGhvc3SHBH8AAAGHBMCoAWwwDQYJKoZIhvcNAQELBQADggGBALFT\n"
    "LEAz14qCy4uhnP700dfvsf0LYFm34fD6CEZJLfoYIohKWChaWqXrSWfRdh3LH7vd\n"
    "+O1zbgnTMAnx1qa1omD1x/uItQvDzsZwdHAARg9WVO56SWbvnCdrkGl3ui4bowvs\n"
    "4PCGgeT/kIUH18tY+CZn8P1x6WPMtgIZpeBXt4IIYciIbjSWvHIpwptxG3wMMljk\n"
    "pj8BmLBxbCrBgCbjAykToaVWOofR7BkVzN5rqs6dB9/5RaPaItgNJ9V7KsOJWXRh\n"
    "79+mauYykS5fJCg96POomBAOhdtBAEbQ0KShaiDXhycwfvCZM86wjdt4RcyhNARR\n"
    "jKdD89h3gVWvglXVBXN5wYwxZuMdVXmf31Ktpu73ftcMOhJsQybXxRBGvTXCdxYU\n"
    "hY7MjpbSYCqnTULkepK/jSE4XbuLN4JeyE4I9OGyqyYWtmqtTjPPOgnd3fTusf6P\n"
    "qMuGSHhBGfXU79l1SlpcALVguFRhvW88P2pMZebHXcnj2pbdIXIjpniTx0AFYQ==\n"
    "-----END CERTIFICATE-----\n";
...
void restart_mqtt_client(void) {
    ...
    const esp_mqtt_client_config_t mqtt_cfg = {
        .broker = {
            .address = {
                // 🌟 1. เปลี่ยนมาใช้ตัวแปรนี้ เพื่อให้หน้าเว็บสั่งเปลี่ยน URL ได้จริง!
                .uri = mqtt_broker_uri_dynamic, 
            },
            .verification = {
                .skip_cert_common_name_check = true,
                // .disable_auto_verify = true,
                // 🌟 2. ใส่ใบรับรองเตรียมไว้ (ESP32 จะข้ามส่วนนี้ไปเองถ้าเราไม่ได้ใช้ wss://)
