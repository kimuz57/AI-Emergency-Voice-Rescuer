...
func RegisterPatientWithDevice(c *fiber.Ctx) error {
    ...
    txErr := database.DB.Transaction(func(tx *gorm.DB) error {
        ...
        // 🟢 นำ caregiver (ที่หาเจอจาก Token) มาผูกเข้ากับคนไข้คนนี้
        // 🟢 บันทึกความสัมพันธ์ลงตาราง 'caregiver_patients' โดยตรง
// ใช้คำสั่ง Table() เพื่อยัดข้อมูลเข้าตารางที่มีอยู่แล้วตามในรูปภาพ
		// 🟢 บันทึกข้อมูลลงตารางตรงกลาง ผ่าน Struct CaregiverPatient ที่คุณสร้างไว้
